...
<div class="fifteen columns">
    ...
    if ($isKeywordFiltering) {?>
      ...
      Showing <code class="clean"><?=$jottingCount?></code>
      jotting<?=$jottingCount>1?'s':''?>
      with tag
    ...
    foreach($jottings as $key=>$value) {
      ...
      echo '
<li class="articles">
  <a href="/jotting/'.$url.'" class="articlelist">
  ...
  <div class="keywords">';
      foreach($keywords as $k) {
        echo '<a href="/jottings/'.$k.'" pp="'.$keydesc[$k].'" class="tooltip">
        <span class="keyword">'.
              $k.
              '</span></a>';
      }
